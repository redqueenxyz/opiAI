// Code from: https://glitch.com/edit/#!/messenger-bot
...
app.get('/webhook', function (req, res) {
  if (
    // TODO: This process.env syntax may not work for GAE; hacky fallback solution for now, but explore deeper. 
    // Works fine on ngrok forwarding and glitch though.
...
function callSendAPI(messageData) {
  request({
    ...
    qs: { access_token: process.env.PAGE_ACCESS_TOKEN || 'EAAafieH0vP8BAD3u9BE64HMXAFmSK2cHsAa5erMgc7DlTsBNDC4Bb5VR8oU8409DZBm6r0QlyxLvxnIujEiXEE11qsLZByhkfMSRS2fFkZBuw4cwrxypyGM9TBj0wJMzllIty1jUmHRUsiPVvYEZCyMhtj1crdlRGsz1ccnCAgZDZD' },
    method: 'POST',
    json: messageData
